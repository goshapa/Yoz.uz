...
const ICON_PATHS: Record<IconName, ReactNode> = {
  reply: (
    <path d="M21 11.5a8.38 8.38 0 0 1-9.9 8.26 8.5 8.5 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 12.3-7.6 8.38 8.38 0 0 1 4.7 7.6z" />
  ),
  repost: (
    <>
  ...
  crown: (
    <>
      <path
        d="M3.5 8.5 7 11l5-6 5 6 3.5-2.5-1.3 8.5H4.8L3.5 8.5Z"
